...
def test_login_send(fix_ture,mocker):
    ...
    assert fix_ture.send_direct_message(os.environ.get('TEST_MESSAGE'), os.environ.get('TEST_SENDER_USERNAME')) is None
